...
class PazEntry:
    ...
    table_offset: int   # Offset of this record inside .pamt
    ...
    def encrypted(self) -> bool:
        """Encrypted files: XML + PALOC + specific CSS."""
        lower = self.path.lower()
        return (
            lower.endswith('.xml')
            or lower.endswith('.paloc')
            or lower.endswith('cdcommon_font_eng.css')
        )
